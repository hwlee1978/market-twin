...
export async function GET(
  ...
  const { data, error } = await supabase
    ...
    .select(
      "id, campaign_label, variant_label, parent_draft_id, body_text, hashtags, cta_text, image_prompt, image_url, source, seo_title, seo_description, seo_keywords, seo_meta, seo_score, seo_notes, seo_scored_at, created_at",
    )
