...
/**
 * Signup is temporarily disabled — the route still resolves (so the
 * marketing-page CTA and the login-page "회원가입" link don't 404),
 * but instead of the form we show a coming-soon screen with a brief
 * explanation and a path back to /login for users who already have
 * an account.
 *
 * To re-enable: restore the previous form-based signup page from
 * git history (file was at src/app/[locale]/(auth)/signup/page.tsx
 * before this commit).
 */
