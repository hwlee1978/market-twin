      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
          />
          <p className="mt-1.5 text-xs text-slate-500">{t("auth.passwordHint")}</p>
        </div>
        {error && (
        ...
        {info && (
          <div className="flex items-start gap-2 rounded-lg border border-success-soft bg-success-soft/40 px-3 py-2 text-sm text-success">
