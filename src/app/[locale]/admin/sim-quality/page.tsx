...
export default async function AdminSimQualityPage({
  ...
  const { data: rawQuality } = await admin
    ...
    .select(
      "simulation_id, workspace_id, audited_at, confidence_score, quarantined, voice_slip_rate, country_score_range, profession_diversity, income_drift_pct, price_in_band, synthesis_failover, warnings",
    )
