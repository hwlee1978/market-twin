...
- 예 시나리오 형식 (가상의 컴포트 슈즈 브랜드 기준 예시):
  ["하루 14시간 서 있는 30대 워킹맘이 매장 마감 시간에 (제품)을 신은 채로 아이를 안아 드는 장면. 시그니처 소재 클로즈업. 카피: '딸을 안기에도, 매장을 닫기에도 가벼운 (카테고리).' 호소: 장시간 착용 편안함 + 모성 감성.",
   "주말 도시 산책하는 40대 부부 뒷모습, 같은 색 제품 신은 발 줌인. 카피: '벗고 싶지 않은 편안함, 둘이서.' 호소: 페어 룩 + 데일리 라이프스타일.",
   "교사·간호사·바리스타 인터뷰 짧은 컷 시리즈, 각자 '리뷰 평점 4.9' 자막. 카피: 'N만 켤레가 증명한 발 건강.' 호소: 사회적 검증 + 직군별 신뢰."]
...
== 요구 응답 JSON 스키마 ==
{
  "name": "...",                       // 예: "(자사 브랜드) (제품명) 일본·미국 진출 검증"
  "productName": "...",                // 예: "(제품 라인) (모델명)"
  "category": "fashion",
  ...
  "competitorNames": ["경쟁사1", "경쟁사2", "경쟁사3"],
  "assetDescriptions": [
