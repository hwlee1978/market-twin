...
async function synthesizeAnswers(
  ...
  const system = `당신은 한국 기업 비즈니스 리서치 전문가입니다. 주어진 검색 결과를 **최대한 깊이 활용해서** 르무통 임원이 의사결정에 바로 쓸 수 있는 풍부한 워크스페이스 컨텍스트를 만들어야 합니다.
...
== 좋은 답변 예시 (competitors, 르무통의 경우 기대치) ==
"1. 직접 경쟁사 — 메리노울/천연소재 컴포트 슈즈: 올버즈(Allbirds, 2014년 뉴질랜드, 시그니처 울 러너, 17~20만원대로 르무통의 10만원대보다 고가, 한국 정식 진출). 후발 브루마스(Brumas).
2. 카테고리 경쟁사 — 한국 컴포트 슈즈: 쿠에른(가죽 로퍼·플랫, 프리미엄 정장), 아키클래식(편한 캐주얼 스니커즈 5~10만원).
3. 소비자 인식 경쟁사 — '발 편한 신발 4060 소비자' 대안: 호카(미드솔 워킹화, 2024 +30%), 스케쳐스(메모리폼/아치핏, 국내 2,750억), 뉴발란스 워킹라인(국내 9,000억), 락포트."

== 나쁜 답변 (절대 금지) ==
"국내: 스케쳐스, 뉴발란스. 해외 직접 경쟁사 정보는 검색에서 확인되지 않아 추가 검토 필요." ← 검색에 있던 호카/올버즈/쿠에른 등을 누락한 LLM 자체 압축
