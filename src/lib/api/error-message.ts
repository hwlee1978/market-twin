  ...
  if (res.status === 402) {
    ...
    const reasonMap: Record<string, { ko: string; en: string }> = {
      ...
      deep_requires_growth: {
        ko: "심층분석 티어는 Growth 이상 플랜에서 사용할 수 있습니다. 하위 티어(초기검증 · 검증분석 · 검증분석 Plus)를 선택하시거나 플랜을 업그레이드하십시오.",
      ...
      deep_pro_requires_enterprise: {
        ko: "심층분석 Pro 티어는 Enterprise 플랜에서만 사용할 수 있습니다.",
