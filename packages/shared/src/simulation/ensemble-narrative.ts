...
// Concreteness scoring moved to ./action-specificity so the results
// page can import it without dragging the LLM providers into the
// client bundle. Re-exported here: callers already import it from
// this module.
import {
  ACTION_SPECIFICITY_SCHEMA,
  assessActionSpecificity,
  type ActionSpecificity,
} from "./action-specificity";
export { assessActionSpecificity };
export type { ActionSpecificity };
